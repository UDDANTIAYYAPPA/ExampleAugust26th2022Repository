...
public class Assaignment8
{
	...
	private static void createcustomer()
	{
		try
		{
			...
			Thread.sleep(500);
			oBrowser.findElement(By.xpath("//*[@id=\'customerLightBox_nameField\']")).sendKeys("kumar158");
			Thread.sleep(500);
	...
	private static void createtask()
	{
		try
		{
			...
			Thread.sleep(500);
			oBrowser.findElement(By.xpath("//*[@id=\"createTasksPopup_createTasksTableContainer\"]/table/tbody/tr[1]/td[1]/input")).sendKeys("newtask");
			Thread.sleep(500);
