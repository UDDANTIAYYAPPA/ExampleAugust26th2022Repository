...
public class Assaignment1 {
	...
	private static void createUser()
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.name("firstName")).sendKeys("ayyappa");
			oBrowser.findElement(By.name("middleName")).sendKeys("A");
			oBrowser.findElement(By.name("lastName")).sendKeys("Q");
	...
	private static void deleteUser()
	{
		try
		{
			oBrowser.findElement(By.xpath("//span[text()='Q, ayyappa A.']")).click();
			Thread.sleep(2000);
